...
export const PaginationProductCollection = [LatestProduct];
export const  OwnProductShema = [LatestProduct];
export const  FavoriteProductShema = [LatestProduct];
export const  SearchProductShema = [LatestProduct];
